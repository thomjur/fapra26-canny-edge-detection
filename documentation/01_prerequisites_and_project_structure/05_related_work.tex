...
unmittelbar folgt. Eine gut lesbare Einführung in die Funktionsweise von 
Canny Edge Detection im Gesamtkontext von Edge Detection findet sich im Buch \textit{Digital Image Processing} 
\cite[S. 729ff.]{gonzalez_digital_2018} im Kapitel zu \enquote{Point, Line, and Edge Detection}.
Von dort wurden auch einige Optimierungen der Formeln entnommen, beispielsweise für den Sobel Filter.
